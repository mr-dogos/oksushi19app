var cordovaApp = {
  ...
  */
  handleAndroidBackButton: function () {
    ...
    document.addEventListener('backbutton', function (e) {
      ...
      if ($('#tab-1.tab-active').length) {
          f7.dialog.confirm('<p style="text-align: center;">Закрыть приложение ?</p>','',()=>{
  ...
  */
  ...
  onDeviceReady: function() {
      document.getElementById("uuid").setAttribute("data-id",device.uuid);
  },
  init: function (f7) {
    // Save f7 instance
    cordovaApp.f7 = f7;
